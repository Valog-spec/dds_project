...
class Category(models.Model):
    ...
    class Meta:
        ...
        unique_together = [
            "name",
            "operation_type",
        ]  # Уникальность в рамках типа операции
...
class Transaction(models.Model):
    ...
    created_date = models.DateTimeField(
        default=timezone.now, verbose_name="Дата создания", null=False, blank=False
    )
    status = models.ForeignKey(
        Status, on_delete=models.PROTECT, verbose_name="Статус", null=False, blank=False
    )
    operation_type = models.ForeignKey(
        OperationType,
